...
class CarroController extends Controller
{
	...
	public function actionCreate()
	{
        ...
        if(isset($_POST['Carro']))
        {
            ...
            $model->foto->saveAs(dirname(__FILE__).'/../../images/carros/'.$model->foto->name);
        ...
        /*
                if (isset($_POST['Carro'])) {
                    ...
                    $ar->attributes = $model;
                    if ($ar->save()) {
                        Yii::app()->user->setFlash('success', 'Foto enviada.');
                        $this->redirect(array('view','id'=>$model->id_carro));
                    } else {
                        Yii::app()->user->setFlash('error', 'A foto não foi salva.');
                        $this->refresh();
                    }
                }
        */
